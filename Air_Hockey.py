...
main_menu_image = PhotoImage(file="Images/MainMenu.png")
mode_select_image = PhotoImage(file="Images/FonForPlay.png")

if main_menu_image:
    main_menu_photo = main_menu_image
...
def start_vs_computer_game():
    ...
    game_background = PhotoImage(file="Images/GameFone.png")
    if game_background:
